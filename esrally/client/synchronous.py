        ...
        *,
        ...
        if self.database_type in ["opensearch", "infino"]:
            ...
            if self.database_type == "opensearch":
                ...
                self.logger.debug(f"Adding Infino auth headers for {method} request to {path}")
                headers.update({
                    "Authorization": "***REMOVED***",
                    "***REMOVED***": "",
                    "***REMOVED***": "***REMOVED***",
                    "***REMOVED***": "***REMOVED***",
                    "***REMOVED***": "***REMOVED***",
                    "***REMOVED***": "***REMOVED***",
                ...
                self.logger.debug(f"Infino headers added: {list(headers.keys())}")
